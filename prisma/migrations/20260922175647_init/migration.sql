-- CreateEnum
CREATE TYPE "StaffRole" AS ENUM ('RECEPTIONIST', 'CLINICIAN', 'DOCTOR', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "OtpPurpose" AS ENUM ('PIN_RESET');

-- CreateEnum
CREATE TYPE "EncounterStatus" AS ENUM ('WAITING', 'IN_CONSULTATION', 'READY_FOR_CHECKOUT', 'DONE');
...
-- CreateIndex
CREATE UNIQUE INDEX "clinics_inviteCode_key" ON "clinics"("inviteCode");
...
-- CreateIndex
CREATE INDEX "otps_patientId_idx" ON "otps"("patientId");
...
-- AddForeignKey
ALTER TABLE "otps" ADD CONSTRAINT "otps_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "encounters" ADD CONSTRAINT "encounters_consultedByStaffId_fkey" FOREIGN KEY ("consultedByStaffId") REFERENCES "staff"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "encounters" ADD CONSTRAINT "encounters_checkedOutByStaffId_fkey" FOREIGN KEY ("checkedOutByStaffId") REFERENCES "staff"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "check_ins" ADD CONSTRAINT "check_ins_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "departments"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
